...
function Home() {
	return (
		<>
			<Helmet title="Inicio">
			<div className="flex items-center justify-center bg-white px-4 min-h-[78px] hover:bg-[#F5F5F5] cursor-pointer rounded-md">
				<div className="flex">
			...
			<div className="flex justify-center gap-4 flex-wrap max-w-[878px] m-auto mt-14">
				<div className="bg-white w-[370px] h-[245px] p-4 rounded-md">
					<div className="flex items-center justify-between">
						<p className="text-[#5F5F5F]">Dinero disponible</p>
						<p className="bg-[#E4F0F8] text-sm text-[#009EE3] px-2 py-1 rounded-md">Tu CVU</p>
					</div>
					...
					<div className="flex items-center justify-between py-2 border-b-[1px]">
						...
						<div>
							<span className="bg-[#E4F0F8] text-[.7rem] text-[#009EE3] px-2 py-1 rounded-md">
								81,2%
							</span>
							<span>
								{">"}
					...
					<div className="text-center py-4">
						<button className="bg-[#E4F0F8] text-sm text-[#009EE3] px-4 py-1 rounded-md mr-2">
							Ingresas dinero
						</button>
						<button className="bg-[#E4F0F8] text-sm text-[#009EE3] px-4 py-1 rounded-md">
							Transferir dinero
						</button>
					</div>
				</div>
				...
				<div className="flex flex-col justify-between bg-white w-[470px] h-[275px] rounded-md">
					<p className="border-b-[1px] w-[370px] py-3 px-4 text-base font-semibold">Tu actividad</p>
					<div className="">
						<div className="pt-6 pb-2">
							<BsCardList className="m-auto text-3xl text-[#5F5F5F]"/>
						</div>
						<p className="m-auto text-center text-[#5F5F5F] font-semibold max-w-[300px]">Usá Mercado Pago y descubrí todo lo que tenemos para vos.</p>
					</div>
					<div className="flex items-center justify-between  border-t-[1px] cursor-pointer">
						<Link className="relative w-full p-4 text-sm text-[#009EE3] text-base font-medium transition duration-150 hover:bg-[#ddd]" to={"/activity"}>
			...
			{/*carrousel*/}
			<div className="m-auto lg:m-0 w-[370px] h-[245px]  my-4">
					<p className="text-lg font-semibold mb-4">Descubrí más</p>
					<div className="flex justify-between bg-white rounded-md p-4 pb-0">
						...
						<img src={discover1} alt="people" width={175}/>
					</div>
			</div>
			<div className="m-auto lg:m-0 flex justify-center flex-col w-[370px] h-[120px] bg-white text-sm mb-4 rounded-md">
			...
			<div className="m-auto lg:m-0 flex flex-col w-[370px] mb-8">
				<button className="flex items-center text-left py-6 px-3 rounded-md bg-white">
					<LuNewspaper className="text-[#009EE3] text-xl"/> 
					<span className="ml-4 text-sm">
						Botón de arrepentimiento
					</span>
				</button>
				<button className="m-auto lg:m-0 flex items-center mt-6 text-left py-4 px-3 rounded-md bg-white">
